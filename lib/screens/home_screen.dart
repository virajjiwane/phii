...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  double _currentSwipeUpDrag = 0.0;
  ...
  void ringingAlarmsChanged(AlarmSet alarms) async {
    ...
    _log.fine(
        'Navigating to alarm ring screen for alarm ID: ${alarms.alarms.first.id}');
          ...
          children: [
            ValueListenableBuilder(
              ...
              builder: (context, Box<Profile> box, _) {
                ...
                _log.fine(
                    'Building profiles list with ${profiles.length} profiles');
                    ...
                    child: Row(
                      children: [
                        Icon(
                          ...
                          color:
                              _isListening ? Colors.red : colorScheme.primary,
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Text(
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Icon(
                              !_isListening ? Icons.add_rounded : Icons.mic,
                              size: 48,
                              color: Colors.white,
                            ),
                          ),
            ...
            child: GestureDetector(
              ...
              onVerticalDragUpdate: (details) {
                if (details.delta.dy < 0) {
                  setState(() {
                    _currentSwipeUpDrag += -details.delta.dy;
                  });
                  if (!_isListening && _currentSwipeUpDrag > 80) {
                    _log.info(
                        'Swipe up threshold reached - starting speech listening');
                    _toggleSpeechListening(context);
                  }
                }
              },
              onVerticalDragEnd: (details) => setState(() {
                _currentSwipeUpDrag = 0.0;
              }),
                ...
                children: [
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: colorScheme.onSurface.withAlpha(
                              (_currentSwipeUpDrag > 80
                                      ? 255
                                      : ((_currentSwipeUpDrag - 50) * 8.5)
                                          .toInt())
                                  .clamp(0, 255),
                            ),
                          ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: colorScheme.onSurface.withAlpha(
                              (_currentSwipeUpDrag > 50
                                      ? 255
                                      : ((_currentSwipeUpDrag - 20) * 8.5)
                                          .toInt())
                                  .clamp(0, 255),
                            ),
                          ),
                        ...
                        Container(
                          ...
                          shape: BoxShape.circle,
                          color: colorScheme.onSurface.withAlpha(
                            (_currentSwipeUpDrag > 20
                                ? 255
                                : (_currentSwipeUpDrag * 12.75).toInt())
                              .clamp(0, 255),
                          ),
                          ),
                        )
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        'Swipe up to give voice command',
